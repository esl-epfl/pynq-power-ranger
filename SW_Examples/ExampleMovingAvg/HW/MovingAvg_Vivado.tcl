...
#
# MovingAvg_Vivado.tcl: Tcl script for re-creating project 'MovingAvg_Vivado'
#
# Generated by Vivado on Fri Aug 29 16:34:04 CEST 2025
...
#
# 1. This project restoration tcl script (MovingAvg_Vivado.tcl) that was generated.
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/HDL/constraints.xdc"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/IP-catalog"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "MovingAvg_Vivado"
...
set script_file "MovingAvg_Vivado.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/MovingAvg_Vivado"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/IP-catalog"]" $obj
...
set file "[file normalize "$origin_dir/HDL/constraints.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/HDL/constraints.xdc"
...
proc cr_bd_design_1 { parentCell } {
  ...
  # Create instance: MovingAvg_0, and set properties
  set MovingAvg_0 [ create_bd_cell -type ip -vlnv EPFL:hls:MovingAvg:1.0 MovingAvg_0 ]
...
\
  ...
  connect_bd_intf_net -intf_net MovingAvg_0_m_axi_gmem [get_bd_intf_pins MovingAvg_0/m_axi_gmem] [get_bd_intf_pins axi_mem_intercon/S00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets MovingAvg_0_m_axi_gmem] [get_bd_intf_pins axi_mem_intercon/S00_AXI] [get_bd_intf_pins system_ila_1/SLOT_0_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins MovingAvg_0/s_axi_control] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins MovingAvg_0/ap_clk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins system_ila_1/clk] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins MovingAvg_0/ap_rst_n] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins system_ila_1/resetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces MovingAvg_0/Data_m_axi_gmem] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs MovingAvg_0/s_axi_control/Reg] -force
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-474,-484",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 7 -x 2170 -y 450 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 7 -x 2170 -y 470 -defaultsOSRD
preplace port Vp_Vn_0 -pg 1 -lvl 0 -x 0 -y 610 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 4 -x 1310 -y 500 -defaultsOSRD
preplace inst MovingAvg_0 -pg 1 -lvl 2 -x 580 -y 240 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 5 -x 1700 -y 300 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 200 -y 290 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 3 -x 940 -y 490 -defaultsOSRD
preplace inst system_ila_0 -pg 1 -lvl 2 -x 580 -y 80 -defaultsOSRD
preplace inst system_ila_1 -pg 1 -lvl 3 -x 940 -y 260 -defaultsOSRD
preplace inst xadc_wiz_0 -pg 1 -lvl 6 -x 2010 -y 340 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 20 190 380 320 780 370 1090 370 1540 480 1860
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 5 20 620 NJ 620 NJ 620 NJ 620 1540
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 5 390 330 790 350 NJ 350 1550 440 1870J
preplace netloc processing_system7_0_FIXED_IO 1 4 3 NJ 470 NJ 470 NJ
preplace netloc processing_system7_0_DDR 1 4 3 NJ 450 NJ 450 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 4 1 1530 220n
preplace netloc ps7_0_axi_periph_M00_AXI 1 1 5 400 160 NJ 160 NJ 160 NJ 160 1850
preplace netloc MovingAvg_0_m_axi_gmem 1 2 1 770 230n
preplace netloc axi_mem_intercon_M00_AXI 1 3 1 N 490
preplace netloc system_ila_0_TRIG_OUT 1 2 1 760 80n
preplace netloc Vp_Vn_0_1 1 0 6 NJ 610 NJ 610 NJ 610 NJ 610 NJ 610 1850J
preplace netloc ps7_0_axi_periph_M01_AXI 1 5 1 N 310
levelinfo -pg 1 0 200 580 940 1310 1700 2010 2170
pagesize -pg 1 -db -bbox -sgen -110 0 2290 630
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/MovingAvg_Vivado/MovingAvg_Vivado.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/MovingAvg_Vivado.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/MovingAvg_Vivado.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/MovingAvg_Vivado.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
