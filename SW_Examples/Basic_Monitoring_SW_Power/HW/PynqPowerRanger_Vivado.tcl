...
#
# PynqPowerRanger_Vivado.tcl: Tcl script for re-creating project 'PynqPowerRanger_Vivado'
#
# Generated by Vivado on Fri May 02 18:05:14 CEST 2025
...
#
# 1. This project restoration tcl script (PynqPowerRanger_Vivado.tcl) that was generated.
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/HDL/PYNQ-Z2-v1.0.xdc"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "PynqPowerRanger_Vivado"
...
set script_file "PynqPowerRanger_Vivado.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/PynqPowerRanger_Vivado"]"
...
set file "[file normalize "$origin_dir/HDL/PYNQ-Z2-v1.0.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "HDL/PYNQ-Z2-v1.0.xdc"
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-1009,-539",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1100 -y 280 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1100 -y 300 -defaultsOSRD
preplace port Vp_Vn_0 -pg 1 -lvl 0 -x 0 -y 220 -defaultsOSRD
preplace inst xadc_wiz_0 -pg 1 -lvl 3 -x 940 -y 410 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 230 -y 330 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 620 -y 130 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 230 -y 100 -defaultsOSRD
preplace inst system_ila_0 -pg 1 -lvl 3 -x 940 -y 200 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 200 450 270 790
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 210 410
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 440 10 770
preplace netloc Vp_Vn_0_1 1 0 3 NJ 220 420J 260 760J
preplace netloc processing_system7_0_DDR 1 1 3 NJ 280 NJ 280 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 300 NJ 300 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 430 70n
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 780 130n
levelinfo -pg 1 0 230 620 940 1100
pagesize -pg 1 -db -bbox -sgen -100 0 1210 520
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/PynqPowerRanger_Vivado/xadc.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/PynqPowerRanger_Vivado.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/PynqPowerRanger_Vivado.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/PynqPowerRanger_Vivado.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
